...
/*   Updated: 2024/04/04 16:16:28 by ozone            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_info_on_screen(t_data *data)
{
	...
	data->info.fov = (int)((atan(sqrt(sqr(data->pos.norm_camX)
	...
	mlx_string_put(data->mlx, data->win, WIN_X - 101, 60, 0x000000, "SENSIVITY : ");
