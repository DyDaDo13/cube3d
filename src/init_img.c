...
void	ft_init_img2(t_data *data, int *i, int *j)
{
	...
	data->textures.EA.img_pix_ptr = mlx_get_data_addr(data->mlx,
			&data->textures.EA.bits_pix, &data->textures.EA.len,
			&data->textures.EA.endian);
	data->img_win.img_ptr = mlx_new_image()
	data->textures.EA.img_pix_ptr = mlx_get_data_addr(data->mlx,
			&data->textures.EA.bits_pix, &data->textures.EA.len,
			&data->textures.EA.endian);
}
...
void	ft_init_img(t_data *data)
{
	...
	data->textures.NO.img_pix_ptr = mlx_get_data_addr(data->mlx,
	...
	data->textures.SO.img_pix_ptr = mlx_get_data_addr(data->mlx,
	...
	data->textures.WE.img_pix_ptr = mlx_get_data_addr(data->mlx,
